    ...
    <View style={style.container}>
      <View style={style.cons}>
        <View style={style.con}>
          <Text style={style.tit}>Buyer : {data.buyer}</Text>
          <Text style={style.tit2}>Orders : {data.orders}</Text>
          <Text style={style.tit2}>Quantity : {data.quantity}</Text>
          <Text style={style.tit2}>
            Buyer Number : {data.delivery_phonenumber}
          </Text>

          <Text style={style.tit2}>Location : {data.delivery_address}</Text>
        </View>
        <View>
          <View
            style={{
